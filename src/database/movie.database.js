...
const movieDatabase = [
    new Movie(1, "O Lorax: Em Busca da Trúfula Perdida", 2012, "Um jovem descobre a história de um ser que lutou para proteger seu mundo.", "Chris Renaud, Kyle Balda", ["Conservação ambiental", "Preservação da natureza", "Impacto do desmatamento"],
      ),
